...
draw_text(1275, 155, "Press F to toggle AA. Currently " + string(filteron) + ".")
draw_text(1275, 170, "Press SPACE to quickswap to idle.")
draw_text(1275, 185, "Press CONTROL to swap to previous animation after quickswap.")
