...
function ui_load_vars_funkin() {
	...
	ui_draw = function() {
		if global.clientprefs.gameplay.downscroll == false {
			...
			draw_text_scribble(642, timebary_center - 20, "[fa_center][fnt_judge][c_black]" + string(obj_song_handler.timestring))
			draw_text_scribble(640, timebary_center - 18, "[fa_center][fnt_judge][c_black]" + string(obj_song_handler.timestring))
			draw_text_scribble(638, timebary_center - 20, "[fa_center][fnt_judge][c_black]" + string(obj_song_handler.timestring))
			draw_text_scribble(640, timebary_center - 22, "[fa_center][fnt_judge][c_black]" + string(obj_song_handler.timestring))
			draw_text_scribble(640, timebary_center - 20, "[fa_center][fnt_judge]" + string(obj_song_handler.timestring))
			...
			draw_text_scribble(642, 720 - 50, "[fa_center][fnt_judge][c_black]" + string(obj_song_handler.timestring))
			draw_text_scribble(640, 720 - 48, "[fa_center][fnt_judge][c_black]" + string(obj_song_handler.timestring))
			draw_text_scribble(638, 720 - 50, "[fa_center][fnt_judge][c_black]" + string(obj_song_handler.timestring))
			draw_text_scribble(640, 720 - 52, "[fa_center][fnt_judge][c_black]" + string(obj_song_handler.timestring))
			draw_text_scribble(640, 720 - 50, "[fa_center][fnt_judge]" + string(obj_song_handler.timestring))
